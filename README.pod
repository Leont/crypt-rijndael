...
=head1 The Crypt::Rijndael module

This is the I<README> for the L<Crypt::Rijndael> Perl module. You're probably 
...
CPAN web interfaces, such as L<CPAN Search|http://search.cpan.org/dist/Crypt-Rijndael> or 
L<MetaCPAN|http://www.metacpan.org/module/Crypt::Rijndael>:

=over 4

=item *	L<http://search.cpan.org/dist/Crypt-Rijndael>

=item *	L<http://www.metacpan.org/module/Crypt::Rijndael>
...
=item *	L<https://github.com/briandfoy/crypt-rijndael>

=back

If you find a problem, file a ticket in the L<issue 
tracker|https://github.com/briandfoy/crypt-rijndael/issues>:

=over 4

=item *	L<https://github.com/briandfoy/crypt-rijndael/issues>
